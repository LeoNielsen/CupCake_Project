    ...
    <div class="topnav">
        ...
        <ul>
            ...
            <li>
                    ...
                    <a class="white-button" href="${pageContext.request.contextPath}/fc/orderrecievepage"><h4>Find
                        us</h4></a>

            </li>
            <li>
                <a class="white-button" href="${pageContext.request.contextPath}/fc/shopcupcakepage"><h4>Menu</h4></a>
            </li>
            <li>
