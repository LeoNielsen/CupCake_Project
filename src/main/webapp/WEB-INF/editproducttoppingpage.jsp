                        ...
                        <div>
                            <table>
                                <tr class="table-labels">
                                    ...
                                    <tr>
                                        <form action="${pageContext.request.contextPath}/fc/addtoppingcommand" method="post">
                        ...
                        <div>
                            <table class="collapse-table">
                                ...
                                <c:forEach var="topping" items="${applicationScope.toppings}">
                                    <tr>
                                        <th style="padding-right: 15px">
                                            <input class="border-input-text" type="text" value="${topping.name}">
                                        </th>
                                        <th style="padding-right: 15px">
                                            <input class="border-input-text" type="number" value="${topping.price}">
                                        </th>
                                        <th>
